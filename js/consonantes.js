...
import {consonantesSample, consonantesSample2, consonantesSample3, consonantesSample4, consonantesSample5, consonantesSounds1} from './sampleWords.js'; 
...
wordsBtn3.forEach((btn, index) => btn.addEventListener('click', () => createExamples(consonantesSample3[index], colors[index], sounds3[index], consonantesSounds1[index])));
...
wordsBtn4.forEach((btn, index) => btn.addEventListener('click', () => createExamples(consonantesSample4[index], colors[index], sounds4[index], consonantesSounds1[index])));
...
wordsBtn5.forEach((btn, index) => btn.addEventListener('click', () => createExamples(consonantesSample5[index], colors[index], sounds5[index], consonantesSounds1[index])));
